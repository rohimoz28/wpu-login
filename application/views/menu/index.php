...
<div class="container-fluid">
	...
	<div class="div row">
		<div class="col-lg-6">
			...
			<!-- Notifikasi muncul jika data berhasil di tambahkan -->
					...
					<?php foreach ($menu as $m) : ?>
						<tr>
							...
							<td>
								...
								<a href="<?= base_url(); ?>menu/deleteMenu/<?= $m['id']; ?>" class="badge badge-pill badge-danger" onclick="return confirm('yakin?');">Delete</a>
							</td>
						</tr>
						<?php $i++; ?>
					<?php endforeach; ?>
